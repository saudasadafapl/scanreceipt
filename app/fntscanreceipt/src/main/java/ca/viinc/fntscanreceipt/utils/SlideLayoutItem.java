...
public class SlideLayoutItem extends FrameLayout {
    ...
    public SlideLayoutItem(Context context) {
        this(context, null);
    }

    public SlideLayoutItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideLayoutItem(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mDragHelper = ViewDragHelper.create(this, mDragHelperCallback);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlideLayout);
        int dragEdgeChoices = a.getInt(R.styleable.SlideLayout_drag_edge, DRAG_RIGHT);
        mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a.getDimension(R.styleable.SlideLayout_leftEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a.getDimension(R.styleable.SlideLayout_rightEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a.getDimension(R.styleable.SlideLayout_topEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(R.styleable.SlideLayout_bottomEdgeSwipeOffset, 0);
        setClickToClose(a.getBoolean(R.styleable.SlideLayout_clickToClose, mClickToClose));
        ...
        int ordinal = a.getInt(R.styleable.SlideLayout_show_mode, ShowMode.PullOut.ordinal());
    ...
    public interface SwipeListener {
        void onStartOpen(SlideLayoutItem layout);

        void onOpen(SlideLayoutItem layout);

        void onStartClose(SlideLayoutItem layout);

        void onClose(SlideLayoutItem layout);

        void onUpdate(SlideLayoutItem layout, int leftOffset, int topOffset);

        void onHandRelease(SlideLayoutItem layout, float xvel, float yvel);
    }
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(SlideLayoutItem.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(SlideLayoutItem.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(SlideLayoutItem.this);
                }
                mEventCounter = 0;
            }
    ...
    public interface OnLayout {
        void onLayout(SlideLayoutItem v);
    }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(SlideLayoutItem.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, SlideLayoutItem.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, SlideLayoutItem.this, p, vId);
                }
                if (handled) {
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(SlideLayoutItem.this, target == surface);
            }
            return true;
        }
    }
    ...
    public interface DoubleClickListener {
        void onDoubleClick(SlideLayoutItem layout, boolean surface);
    }
